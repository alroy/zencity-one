    ...
    <>
      <style jsx global>{`
        ...
        @keyframes pulseHalo {
          ...
          50% {
            box-shadow: 0 0 0 8px rgba(59, 209, 187, 0.2);
          }
        }
          ...
          <div className="toolkit-button-wrapper">
            <DropdownMenu open={dropdownOpen} onOpenChange={setDropdownOpen}>
              <DropdownMenuTrigger asChild>
                <Button
                  className={`h-10 px-3 flex items-center gap-2 bg-[#3BD1BB]/10 hover:bg-[#3BD1BB]/20 text-[#3BD1BB] border border-[#3BD1BB]/30 font-medium ${
